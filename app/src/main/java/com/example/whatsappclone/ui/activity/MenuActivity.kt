...
class MenuActivity() : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        profileViewModel = ViewModelProvider(this@MenuActivity,
        profileViewModelProviderFactory)[ProfileViewModel::class.java]
        ...
        contactsViewModel = ViewModelProvider(this@MenuActivity,
        contactsViewModelProviderFactory)[ContactsViewModel::class.java]
        ...
        messagesViewModel = ViewModelProvider(this@MenuActivity,
        messagesViewModelProviderFactory)[MessagesViewModel::class.java]
